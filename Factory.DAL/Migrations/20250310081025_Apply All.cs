    ...
    public partial class ApplyAll : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Index", "PermissionManagement", true, "Permission List", "e3627b83b5", 2 },
                    { 2, "AssignPermissions", "PermissionManagement", true, "Assign Permission", "4c76064353", 2 },
                    { 3, "Index", "Module", true, "Module List", "dbf1fcbbd3", 3 },
                    { 4, "Create", "Module", true, "Add Module", "580d052ee8", 3 },
                    { 5, "Index", "SubModule", true, "Submodule List", "9b92e9c3f8", 4 },
                    { 6, "Create", "SubModule", true, "Add Submodule", "2eb33b76bf", 4 },
                    { 7, "Index", "Auth", true, "User List", "edb8a6dc79", 1 },
                    { 8, "Create", "Auth", true, "Add User", "150ef2a89a", 1 },
                    { 9, "Index", "Role", true, "Role List", "425d9a4e00", 3 },
                    { 10, "Create", "Role", true, "Add Role", "de26362526", 3 },
                    { 11, "Index", "Warehouse", true, "Warehouse List", "1ddbffe722", 5 },
                    { 12, "Create", "Warehouse", true, "Add Warehouse", "d9e83e7bfe", 5 },
                    { 13, "Index", "Item", true, "Item List", "652e053ef2", 6 },
                    { 14, "Create", "Item", true, "Add Item", "792e794119", 6 },
                    { 15, "Create", "Order", true, "Create Order", "8d1933be73", 7 },
                    { 16, "Index", "Order", true, "Order List", "0be3c00e1b", 8 },
                    { 17, "General", "Settings", true, "General Settings", "7be13f21e1", 17 },
                    { 18, "Security", "Settings", true, "Security Settings", "498503021c", 18 },
                    { 19, "Index", "Payroll", true, "Payroll Dashboard", "0f96a0bd2e", 9 },
                    { 20, "EmployeeSalaries", "Payroll", true, "Employee Salaries", "4a30231267", 10 },
                    { 21, "ProcessSalaries", "Payroll", true, "Salary Processing", "35d892e365", 9 },
                    { 22, "Reports", "Payroll", true, "Payroll Reports", "e83b5e9427", 15 },
                    { 23, "Bonuses", "Payroll", true, "Bonuses Management", "700434ff17", 9 },
                    { 24, "Deductions", "Payroll", true, "Deductions", "964080549f", 9 },
                    { 25, "Tax", "Payroll", true, "Tax Calculations", "a5e13bc58f", 9 },
                    { 26, "GeneratePayslip", "Payroll", true, "Payslip Generation", "ed5cd7316a", 9 },
                    { 27, "Overtime", "Payroll", true, "Overtime Payments", "f5056177b4", 9 },
                    { 28, "History", "Payroll", true, "Payroll History", "ef7a55d2d9", 9 },
                    { 29, "Index", "Accountant", true, "Financial Orders", "46e07dd90f", 15 },
                    { 30, "PreOnboarding", "Onboarding", true, "Pre-Onboarding", "3ab01efff2", 10 },
                    { 31, "ITSetup", "Onboarding", true, "IT Setup", "d1cc03ce4f", 10 },
                    { 32, "Training", "Onboarding", true, "Training & Orientation", "cb4fc5fb00", 10 },
                    { 33, "Clearance", "Offboarding", true, "Exit Clearance", "ad1633e608", 10 },
                    { 34, "RevokeAccess", "Offboarding", true, "Access Revocation", "38a2fcde81", 10 },
                    { 35, "FinalPayroll", "Offboarding", true, "Final Payroll & Documents", "f8057bd19e", 10 },
                    { 36, "Records", "HR", true, "Employee Records", "f1912a4202", 10 },
                    { 37, "Leave", "HR", true, "Leave Management", "040a020bc3", 10 },
                    { 38, "Payroll", "HR", true, "Payroll Processing", "a4f280ab69", 9 },
                    { 39, "Reviews", "Performance", true, "Performance Reviews", "d309568b36", 10 },
                    { 40, "KPIs", "Performance", true, "KPI Tracking", "f6b4468a18", 10 },
                    { 41, "Feedback", "Performance", true, "Feedback & Recognition", "4478d8f035", 10 },
                    { 42, "Tickets", "ITService", true, "Ticket Management", "059887f93d", 11 },
                    { 43, "Monitoring", "ITService", true, "System Monitoring", "c4512e305b", 12 },
                    { 44, "Inventory", "ITService", true, "Hardware Inventory", "3a5e9853b5", 5 },
                    { 45, "Tickets", "Support", true, "Support Tickets", "b29c54384b", 13 },
                    { 46, "Chat", "Support", true, "Live Chat", "7d3574a8db", 14 },
                    { 47, "FAQ", "Support", true, "FAQ & Help Center", "6164060eca", 13 },
                    { 48, "Finance", "Reports", true, "Financial Reports", "f71dbb2ece", 15 },
                    { 49, "Employees", "Reports", true, "Employee Insights", "248760c5c2", 15 },
                    { 50, "Sales", "Reports", true, "Sales & Revenue", "68f171e7cc", 15 },
                    { 51, "Index", "Support", true, "Support Dashboard", "4921e48388", 13 },
                    { 52, "Index", "OrderReport", true, "Orders Dashboard", "27d5537d54", 8 },
                    { 53, "Settings", "ExportImport", true, "Data Management", "02211b33c5", 17 },
                    { 54, "Export", "ExportImport", true, "Data Export", "f043f1d84f", 17 },
                    { 55, "Import", "ExportImport", true, "Data Import", "dd1ed57c00", 17 },
                    { 56, "Index", "OrderReport", true, "Order Dashboard", "cfe2bdd8a1", 16 }
                });
